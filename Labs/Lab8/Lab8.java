...
public class Lab8 {
	...
	// it to work with the MyRectangle class or the MySquare class. Note also
	// that it will NOT work with MySquare unless MySquare is a subclass of
	// MyRectangle. Finally, note that the isInside() method can be used as
	// is from MyRectangle -- you do not have to redefine it for MySquare
	...
	public static void main(String[] args) {
		...
		// incorrect since the width and height can be assigned to different
		// values.
		// Thus you should redefine the same method (with the same header) in
		// the
		// MySquare class so that it makes the assignment only if the width and
		// height
		// are the same (since the object is a square). This is called method
		// overriding and we will discuss it soon.
